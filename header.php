		...
		<div class="page">
			<header>
				<nav class="main-menu full">
 					<a id="navLogoLink" href="http://osi.ucf.edu/creative-services/"><img class="navLogo" src="<?php echo get_stylesheet_directory_uri(); ?>/resources/CSlogo.png" alt="Creative Services Logo"></a>
