...
/* Query for the posts. */
$creativeLoop = new WP_QUERY(array('post__not_in' => $post_ids, 'post_type' => 'portfolio', 'posts_per_page' => 12, 'orderby' => 'date', 'order' => 'DSC'));
...
if ($creativeLoop -> has_posts()) : while ($creativeLoop -> has_posts()) : $creativeLoop -> the_post;
	$content .= "<div data-post-id = ' " . get_the_id() . " ' class = 'item'>";
	$content .= "</div>";
